  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#0B0B0B] text-white font-['Montserrat']">
      ...
      >
        ...
        {/* Container centralizado para alinhar com o conteúdo do ProjectsDetail */}
